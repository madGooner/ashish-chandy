import{V as e}from"./index-DrqYoSho.js";const s={uniforms:{tDiffuse:{value:null},uOffset:{value:.5},uCenter:{value:new e(.5,.5)},uRadius:{value:.2},uSoftness:{value:.05},uResolution:{value:new e(1,1)}},vertexShader:`
        varying vec2 vUv;
        void main() {
            vUv = uv;
...
//# sourceMappingURL=LocalizedChromaticShader-Bb_6w2Ky.js.map
